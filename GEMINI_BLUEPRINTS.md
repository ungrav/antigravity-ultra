...
> El kit portable visible conserva 5 archivos raíz: `GEMINI.md`, `MEMORY.md`, `GEMINI_BLUEPRINTS.md`, `portable-kernel.sh` y `portable-kernel-windows.ps1`, más el bundle externo `.portable/minimum-kernel.bundle.tar.gz`.
...
> Los artefactos se restauran desde el bundle comprimido externo; `GEMINI_BLUEPRINTS.md` ya no pega base64 gigante en Markdown.
...
> [!NOTE]
> v9 externaliza el bundle portable para que `GEMINI_BLUEPRINTS.md` siga siendo legible por agentes.
> Los launchers leen primero `.portable/minimum-kernel.bundle.tar.gz`; el marcador base64 legado solo existe como fallback en kits antiguos.
...
- Bundle: `.portable/minimum-kernel.bundle.tar.gz`
- Manifest: `.portable/bundle_manifest.json`
- Legacy marker: `portable:minimum-kernel.bundle.tar.gz.base64` is intentionally absent from v9 blueprints.

~~~~json
{
  "version": 1,
  "generated_at": "2026-05-06T14:51:35Z",
  ...
  "artifacts": [
    ...
    {
      "path": "workflows/agentic-stack-sync-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/blueprint-integrity-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
      "path": "workflows/blueprint-maintenance-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/context-compaction-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/external-implementation-governance-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/git-safety-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/pre-plan-intelligence-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/session-warmup-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
      "path": "workflows/skill-acquisition-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/snapshot-context-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
      "path": "workflows/sub-agent-delegation-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
    ...
    {
      "path": "workflows/verify-skills-workflow.md",
      "category": "workflows",
      "component": "advanced_workflows"
    },
    {
